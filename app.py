...
# ============================================================================
# FUNÇÕES DE VISUALIZAÇÃO E PÁGINAS
# ============================================================================
...
def mostrar_pagina_inicio():
    """Página inicial do aplicativo com interface melhorada"""
    ...
    with col1:
        ...
        """)
        # CORREÇÃO: use_container_width ao invés de use_column_width
...
def mostrar_pagina_simulacao(detector):
    ...
    if detector.modelo_bayes is None:
        st.warning("⚠️ O modelo Bayesiano não está treinado. Treinando modelo com parâmetros padrão...")
